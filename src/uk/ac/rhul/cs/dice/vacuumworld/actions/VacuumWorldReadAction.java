...
public class VacuumWorldReadAction extends ReadAction {
	 ...
	 *            to read {@link uk.ac.rhul.cs.dice.vacuumworld.common.Dirt
	 *            Dirt} related information from
	 ...
	 */
	public VacuumWorldReadAction(CollectionRepresentation dirtCollection, CollectionRepresentation agentCollection, int lastCycleRead) {
