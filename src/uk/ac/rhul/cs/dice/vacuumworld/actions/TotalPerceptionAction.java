 ...
 * in {@link VacuumWorldMonitoringContainer}.
 * 
 * @author Ben Wilkins
 *
 */
public class TotalPerceptionAction extends AbstractAction {
	...
	public boolean isPossible(Physics physics, Space context) {
		return ((VacuumWorldMonitoringPhysics) physics).isPossible(TotalPerceptionAction.this, context);
	}

	@Override
	public boolean isNecessary(Physics physics, Space context) {
		return ((VacuumWorldMonitoringPhysics) physics).isNecessary(TotalPerceptionAction.this, context);
	}

	@Override
	public Result perform(Physics physics, Space context) {
		return ((VacuumWorldMonitoringPhysics) physics).perform(TotalPerceptionAction.this, context);
	}

	@Override
	public boolean succeeded(Physics physics, Space context) {
		return ((VacuumWorldMonitoringPhysics) physics).succeeded(TotalPerceptionAction.this, context);
	}
