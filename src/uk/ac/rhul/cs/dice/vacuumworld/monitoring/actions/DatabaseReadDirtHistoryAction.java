...
public class DatabaseReadDirtHistoryAction extends DatabaseSingleReadHistoryAction {

	public DatabaseReadDirtHistoryAction(VacuumWorldDatabaseInteractions actionToPerform, String idToReadAbout) {
