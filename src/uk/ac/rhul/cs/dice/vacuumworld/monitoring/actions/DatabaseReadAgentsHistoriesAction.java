...
public class DatabaseReadAgentsHistoriesAction extends DatabaseReadAction {

	public DatabaseReadAgentsHistoriesAction(VacuumWorldDatabaseInteractions actionToPerform) {
