...
public class DatabaseReadUserHistoryAction extends DatabaseSingleReadHistoryAction {

	public DatabaseReadUserHistoryAction(VacuumWorldDatabaseInteractions actionToPerform, String idToReadAbout) {
