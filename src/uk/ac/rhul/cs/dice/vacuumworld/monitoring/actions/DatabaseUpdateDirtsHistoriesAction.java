...
public class DatabaseUpdateDirtsHistoriesAction extends DatabaseWriteHistoriesAction {

	public DatabaseUpdateDirtsHistoriesAction(VacuumWorldDatabaseInteractions actionToPerform, List<VacuumWorldMonitoringActionResult> historiesWrappers) {
