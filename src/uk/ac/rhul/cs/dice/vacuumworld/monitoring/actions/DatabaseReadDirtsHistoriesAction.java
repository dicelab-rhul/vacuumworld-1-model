...
public class DatabaseReadDirtsHistoriesAction extends DatabaseReadAction {

	public DatabaseReadDirtsHistoriesAction(VacuumWorldDatabaseInteractions actionToPerform) {
