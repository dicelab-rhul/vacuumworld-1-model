...
import uk.ac.rhul.cs.dice.vacuumworld.legacy.basicmonitor.VacuumWorldMonitorBrain;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.basicmonitor.VacuumWorldMonitorMind;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.basicmonitor.VacuumWorldMonitorSensor;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.basicmonitor.VacuumWorldStepEvaluationStrategy;
...
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWEvaluatorBrain;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWEvaluatorMind;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWEvaluatorSensor;
...
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWObserverBrain;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWObserverMind;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VWObserverSensor;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.VacuumWorldDatatbaseStepEvaluationStrategy;
...
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.database.VacuumWorldMongoBridge;
import uk.ac.rhul.cs.dice.vacuumworld.legacy.evaluator.observer.database.VacuumWorldMongoConnector;
