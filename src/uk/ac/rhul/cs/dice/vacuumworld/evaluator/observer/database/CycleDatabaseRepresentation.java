 ...
 * a {@link VacuumWorldCleaningAgent} in a given cycle. </br> Uses: in
 * {@link AgentDatabaseRepresentation} to representation cyclic data. This
 * representation will be converted to a JSON String by {@link ObjectMapper}
 * indirectly via {@link AgentDatabaseRepresentation}. </br> See also:
 * {@link VacuumWorldMongoBridge}.
 * 
 * @author Ben Wilkins
 *
 */
public class CycleDatabaseRepresentation {
  ...
  public CycleDatabaseRepresentation(int x, int y, AgentFacingDirection dir,
      SpeechDatabaseRepresentation speech) {
    this.x = x;
    this.y = y;
    this.dir = dir;
