...
public class VacuumWorldSpace extends EnvironmentalSpace {
  ...
  public VacuumWorldSpace(int[] dimensions) {
    ...
    for (int i = 0; i < this.dimensions[0]; i++) {
      for (int j = 0; j < this.dimensions[1]; j++) {
        ...
        this.addLocation(coordinates, new VacuumWorldLocation(coordinates,
            VacuumWorldLocationType.NORMAL, this.dimensions[0] - 1,
            this.dimensions[1] - 1));
      }
    }
  }
  ...
  public Set<VacuumWorldCleaningAgent> getAgents() {
    return new HashSet<VacuumWorldCleaningAgent>(agents.values());
  }

  public VacuumWorldLocation getNorthernLocation(int x, int y) {
    return (VacuumWorldLocation) this.getLocation(new VacuumWorldCoordinates(x,
        y - 1));
  }

  public VacuumWorldLocation getNorthernLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getNorthernCoordinates());
  }
  ...
  public VacuumWorldLocation getSouthernLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getSouthernCoordinates());
  }

  public VacuumWorldLocation getWesternLocation(int x, int y) {
    return (VacuumWorldLocation) this.getLocation(new VacuumWorldCoordinates(
        x - 1, y));
  }

  public VacuumWorldLocation getWesternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getWesternCoordinates());
  }
  ...
  public VacuumWorldLocation getEasternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getEasternCoordinates());
  }
  ...
  public VacuumWorldLocation getNorthWesternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getNorthWesternCoordinates());
  }
  ...
  public VacuumWorldLocation getNorthEasternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getNorthEasternCoordinates());
  }
  ...
  public VacuumWorldLocation getSouthWesternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getSouthWesternCoordinates());
  }
  ...
  public VacuumWorldLocation getSouthEasternLocation(
      VacuumWorldCoordinates coordinates) {
    return (VacuumWorldLocation) this.getLocation(coordinates
        .getSouthEasternCoordinates());
  }

  public VacuumWorldLocation getFrontLocation(
      VacuumWorldCoordinates coordinates, AgentFacingDirection agentDirection) {
  ...
  public VacuumWorldLocation getFrontLeftLocation(
      VacuumWorldCoordinates coordinates, AgentFacingDirection agentDirection) {
    switch (agentDirection) {
    case NORTH:
  ...
  public VacuumWorldLocation getFrontRightLocation(
      VacuumWorldCoordinates coordinates, AgentFacingDirection agentDirection) {
    switch (agentDirection) {
    case NORTH:
      return getNorthEasternLocation(coordinates);
  ...
  public VacuumWorldLocation getLeftLocation(
      VacuumWorldCoordinates coordinates, AgentFacingDirection agentDirection) {
    switch (agentDirection) {
    case NORTH:
      return getWesternLocation(coordinates);
  ...
  public VacuumWorldLocation getRightLocation(
      VacuumWorldCoordinates coordinates, AgentFacingDirection agentDirection) {
    switch (agentDirection) {
    case NORTH:
      return getEasternLocation(coordinates);
  ...
  public void update(CustomObservable o, Object arg) {
    if (o instanceof VacuumWorldDefaultActuator
        && arg instanceof VacuumWorldEvent) {
